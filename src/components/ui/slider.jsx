  ...
  return (
    <SliderPrimitive.Root
      ...
      <SliderPrimitive.Track
        ...
        className="relative grow overflow-hidden rounded-full bg-[var(--control-track)] data-horizontal:h-2 data-horizontal:w-full data-vertical:h-full data-vertical:w-2">
